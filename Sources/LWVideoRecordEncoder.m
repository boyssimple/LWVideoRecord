...
@interface LWVideoRecordEncoder ()
...
@implementation LWVideoRecordEncoder
...
+ (LWVideoRecordEncoder*)encoderForPath:(NSString*) path Height:(NSInteger) cy width:(NSInteger) cx channels: (int) ch samples:(Float64) rate {
    LWVideoRecordEncoder* enc = [LWVideoRecordEncoder alloc];
