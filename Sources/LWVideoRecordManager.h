...
@protocol LWVideoRecordManagerDelegate <NSObject>
...
@interface LWVideoRecordManager : NSObject
...
@property (weak, nonatomic) id<LWVideoRecordManagerDelegate>delegate;
